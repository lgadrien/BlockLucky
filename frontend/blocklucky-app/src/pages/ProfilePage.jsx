  ...
  useEffect(() => {
    const fetchBalance = async () => {
      ...
      try {
        ...
        // formatEther convertit BigInt → string ETH
        const balanceEthString = ethers.formatEther(balanceWei)
        // Manipulation de string pour 4 décimales (pas de Number() !)
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="pb-20">
        ...
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-blockchain-500 via-blockchain-600 to-chance-600 text-white pt-32 pb-32">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-3xl font-bold text-anthracite-900">
                        {loading ? 'Chargement...' : balance !== null ? `${balance} ETH` : '0 ETH'}
                      </p>
